      ...
      <div>
        <div className=" whitespace-break-spaces mt-20 md:ml-14 md:p-1 ml-5 ">
          <div className=" md:flex md:justify-start md:items-start md:ml-20  flex  ml-0">
            <p>
              <Link href="/"> Home </Link> / <b>Contact</b>
            </p>
          </div>
        </div>
        ...
        <div className=" md:flex md:gap-4 md:ml-10 md:mt-20 md:mr-10 md:mb-20 mt-10  ">
          ...
          <div className=" md:w-4/5 mt-4  ">
            <div className="md:flex  md:gap-10 md:justify-evenly md:h-16 flex flex-col md:flex-row ml-6 md:ml-0 gap-3   ">
              <input
                className="md:p-5 p-2 md:mr-10 bg-gray-100 w-80 md:w-60  outline-none md:ml-6 md:h-auto h-12  "
                placeholder="Your Name *"
              />
              <input
                className="md:p-5 p-2 bg-gray-100 w-80 md:w-60 outline-none md:h-auto h-12  "
                placeholder="Your Email *"
              />
              <input
                className="md:p-5 p-2 bg-gray-100 w-80 md:w-80 outline-none md:h-auto h-12  md:mr-6 "
                placeholder="Your Phone *"
              />
            </div>
            <div className="md:ml-12 md:flex md:flex-col md:mt-10 md:mr-12 md:h-4/6 ml-6 mt-3  ">
              <textarea
                className="bg-gray-100 md:h-full md:text-start md:p-4 p-2 outline-none md:w-full w-80   h-32"
