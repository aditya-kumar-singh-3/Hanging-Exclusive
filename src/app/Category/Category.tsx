  ...
  return (
    <>
      <div className="container  px-4 min-w-full">
        ...
        <div className="flex items-center justify-between    md:mr-40 mr-4 mt-8 ml-2  md:w-auto w-full select-none">
        ...
        <div className="flex flex-wrap justify-evenly mt-16  ml-4  mr-4 gap-4">
